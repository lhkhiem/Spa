...
exports.reorderSliders = exports.deleteSlider = exports.updateSlider = exports.createSlider = exports.getSliderById = exports.getAllSliders = void 0;
...
const getAllSliders = async (req, res) => {
    ...
    `;
        ...
        const sliders = await database_1.default.query(query, {
...
const createSlider = async (req, res) => {
    ...
    `;
        ...
        // Log activity
        await (0, activityLogController_1.logActivity)(req, 'create', 'slider', id, title, `Created slider "${title}"`);
...
const updateSlider = async (req, res) => {
    ...
    `;
        ...
        const sliderResult = await database_1.default.query(getSliderQuery, {
            type: sequelize_1.QueryTypes.SELECT,
            bind: [id],
        });
        const sliderTitle = sliderResult[0]?.title || title || 'Unknown';
        // Log activity
        await (0, activityLogController_1.logActivity)(req, 'update', 'slider', id, sliderTitle, `Updated slider "${sliderTitle}"`);
...
const deleteSlider = async (req, res) => {
    try {
        ...
        // Log activity
        await (0, activityLogController_1.logActivity)(req, 'delete', 'slider', id, sliderTitle, `Deleted slider "${sliderTitle}"`);
    ...
    try {
        ...
        await database_1.default.transaction(async (transaction) => {
            for (const item of items) {
                await database_1.default.query('UPDATE sliders SET order_index = $1, updated_at = NOW() WHERE id = $2', {
                    type: sequelize_1.QueryTypes.UPDATE,
