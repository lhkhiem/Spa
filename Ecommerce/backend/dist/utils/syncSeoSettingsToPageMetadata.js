...
exports.syncSeoSettingsToPageMetadata = syncSeoSettingsToPageMetadata;
 ...
 */
async function syncSeoSettingsToPageMetadata(pages) {
    try {
        ...
        const providedPaths = new Set();
        const providedPathsMap = new Map(); // path -> page data
        ...
        const allExistingPages = await PageMetadata_1.default.findAll();
...
//# sourceMappingURL=syncSeoSettingsToPageMetadata.js.map