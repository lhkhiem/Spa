...
async function findStuckOrders() {
    ...
    LIMIT 100
  `;
    const orders = await database_1.default.query(query, {
...
async function fixOrder(order) {
    try {
        ...
        const queryResult = await (0, zalopay_1.queryZaloPayOrder)(order.zp_app_trans_id);
...
//# sourceMappingURL=fixStuckZaloPayOrders.js.map