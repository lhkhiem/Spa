...
import { buildApiUrl, getNormalizedApiBaseUrl } from '@/lib/api';
    ...
    const fetchAppearance = async () => {
      ...
      try {
        ...
        if (appearance.favicon_url && typeof appearance.favicon_url === 'string' &&
          !appearance.favicon_url.startsWith('http://') &&
          !appearance.favicon_url.startsWith('https://')) {
          appearance.favicon_url = `${apiBase}${appearance.favicon_url}`;
        }
        if (appearance.logo_url && typeof appearance.logo_url === 'string' &&
          !appearance.logo_url.startsWith('http://') &&
          !appearance.logo_url.startsWith('https://')) {
          appearance.logo_url = `${apiBase}${appearance.logo_url}`;
        }
        try {
