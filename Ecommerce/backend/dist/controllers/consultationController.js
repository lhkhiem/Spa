...
exports.getConsultationStats = exports.deleteConsultation = exports.updateConsultation = exports.getConsultationById = exports.getConsultations = exports.submitConsultation = void 0;
const ConsultationSubmission_1 = __importDefault(require("../models/ConsultationSubmission"));
...
const submitConsultation = async (req, res) => {
    try {
        ...
        const consultation = await ConsultationSubmission_1.default.create({
            name: name.trim(),
            phone: phone.trim(),
...
const getConsultations = async (req, res) => {
    try {
        const { status, province, search, page = '1', limit = '20', sortBy = 'created_at', sortOrder = 'DESC', } = req.query;
        ...
        if (search) {
            whereConditions.push('(cs.name ILIKE :search OR cs.phone ILIKE :search OR cs.email ILIKE :search OR cs.message ILIKE :search)');
    ...
    `;
        ...
        const submissions = await database_1.default.query(query, {
            replacements,
            type: sequelize_1.QueryTypes.SELECT,
        });
        res.json({
...
const getConsultationById = async (req, res) => {
    try {
        const { id } = req.params;
        const submission = await ConsultationSubmission_1.default.findByPk(id, {
            include: [
                {
...
const getConsultationStats = async (req, res) => {
    ...
    `;
      ...
      LIMIT 10
    `;
        const provinceStats = await database_1.default.query(provinceStatsQuery, {
            type: sequelize_1.QueryTypes.SELECT,
        });
        res.json({
            success: true,
